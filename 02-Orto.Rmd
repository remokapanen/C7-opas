...
Wikin tärppejä on hieman vaikeaa käydä läpi, joten tein parannellun version niistä. Löytyy [täältä](https://ortotarpit.netlify.app/)
...
## 16: Replantaatiot ja amputaatiot 

Trauma Kandikurssi TAKE HOME -diojen Yläraajan takaisinistutusleikkaukset -dia riittää. Lisäksi voi halutessaan lukea tarkemmin aiheesta: 

- Traumatologia, Kandidaattikustannus kpl 48 
- Käsikirurgia, Kandidaattikustannut kpl 10.2

## 17: Hermovammat 

Trauma Kandikurssi TAKE Home -diojen hermovammat-diassa lyhyt tiivistelmä, mutta se ei riitä. Hermovammat kuuluvat kirjasta tenttialueeseen ja niitä käsittelevät kappaleet kannattaa lukea. 

- Traumatologia, Kandidaattikustannus kpl 24
- Käsikirurgia, Kandidaattikustannut kpl 9.1



## Käsikirurgian tietoiskut {#Kasikirurgian-tietoiskut}

### Tietoisku 02

Käden kulumavaiva ja sen hoito. Tietoisku riittää. 

- Halutessaan voi lisäksi lukea kpl 3.2 (Käden ja ranteen nivelrikko) kirjasta Käsikirurgia, Kandidaattikustannus
- Käden nivelrikosta on myös [Duodecim-artikkeli](https://www.terveysportti.fi/apps/dtk/ltk/article/duo15687)

### Tietoisku 03 

Napsusormi ja sen hoito. Tietoisku riittää. 

- Halutessaan voi lisäksi lukea kpl 11.2 (Käden tavalliset jännetuppitulehdukset) kirjasta Käsikirurgia, Kandidaattikustannus
- Napsusormesta on myös lyhyt [Terveysportti-artikkeli](https://www.terveysportti.fi/apps/dtk/ltk/article/ykt01435)

###  Tietoisku 04 

Rannekanavaoireyhtymä. Pääasiassa tietoisku riittää, mutta kannattanee lukea myös: 
